...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post talks_url, params: { talk: { description: @talk.description, title: @talk.title, votes: @talk.votes } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { description: @talk.description, title: @talk.title, votes: @talk.votes } }
